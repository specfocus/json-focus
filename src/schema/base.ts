...
import toArray from './validate/toArray';
import { Callback, ExtraParams, InternalOptions, Message, ValidateOptions } from './validate/types';
import { getIn } from './reach';
...
export interface Config<C = Any, F extends Flags = ''> {
  context: C;
  flags: F;
}
