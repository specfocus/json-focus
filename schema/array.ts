...
import { array as locale } from './validate/locale';
import printValue from './validate/printValue';
import runTests, { RunTest } from './validate/runTests';
import {
  Callback, InternalOptions, Message
} from './validate/types';
...
export declare interface ArrayJsonSchema<T extends SimpleArray, _partial extends boolean = false> {
  ...
  contains?: Partial<JsonSchema<T[0]>>;
  minItems?: number;
  maxItems?: number;
  minContains?: number;
  maxContains?: number;
